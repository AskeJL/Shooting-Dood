...
public class Bullet extends Entity {
    ...
    public static Entity createBullet(Entity weapon) {
        PositionPart weaponPosition = weapon.getPart(PositionPart.class);
        ShootingPart shoot = weapon.getPart(ShootingPart.class);
        Entity bullet = new Bullet();

        
        bullet.add(new PositionPart(weaponPosition.getX(), weaponPosition.getY(), weaponPosition.getRotation()));
        ...
        bullet.add(new ProjectilePart(weapon.getID()));
        bullet.setRadius(2);
